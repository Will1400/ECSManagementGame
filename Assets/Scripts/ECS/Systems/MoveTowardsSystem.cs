...
public class MoveTowardsSystem : JobComponentSystem
{
    ...
    private struct MoveJob : IJobForEachWithEntity<MoveTowardsComponent, Translation, MoveSpeedComponent>
    {
        public float deltatime;

        public void Execute(Entity entity, int index, ref MoveTowardsComponent moveTowardsComponent, ref Translation translation, ref MoveSpeedComponent moveSpeedComponent)
        {
